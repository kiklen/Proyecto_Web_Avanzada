<%-- 
    ...
    Created on : 13/05/2019, 12:12:40 AM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        <div style="width: 100%; height: 15%; background-color: cornflowerblue">
            <center>
                <h1 style="color: white; text-shadow: 2px 2px 2px #000;">Modificar Usuario</h1>
            </center>            
        </div>
        ...
        <div style="position: absolute; top: 45%;left: 35%; box-shadow: 0px 0px 4px 2px #A1A1A1; height: 20%; width: 25%; padding: 3vh; border-radius: 5px">
            <form action="" method="post">
                ...
                Password: <input type="text" name="pass" style="margin-bottom: 1vh;border-radius: 5px"> <br>
                Nombre: <input type="text" name="nombre" style="margin-bottom: 5vh;border-radius: 5px; margin-left: 1.3vh"> <br>
                <div>
